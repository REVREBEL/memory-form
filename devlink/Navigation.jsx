    ...
    <_Component className={_utils.cx(_styles, "nav")} tag="div">
      ...
      >
        <_Builtin.Block
          ...
          id={_utils.cx(
            _styles,
            "w-node-_29ecd6d6-2746-86af-d2e8-9776c008cd03-c008cd01"
          )}
          tag="div"
        >
          <_Builtin.Image
            className={_utils.cx(_styles, "monogram", "is-hidden-desktop")}
            loading="lazy"
            width="auto"
            height="auto"
            alt=""
          ...
          />
          <_Builtin.Image
            className={_utils.cx(_styles, "monogram", "is-hidden-mobble-p")}
            loading="lazy"
            width="auto"
            height="auto"
            alt=""
          ...
          >
            <_Builtin.Block
              className={_utils.cx(_styles, "home-button", "navbar")}
              tag="div"
            >
              <_Builtin.Image
                className={_utils.cx(_styles, "monogram", "is-hidden-mobile-l")}
                loading="lazy"
                width="auto"
                height="auto"
                alt=""
        ...
        <_Builtin.Block
          ...
          id={_utils.cx(
            _styles,
            "w-node-_29ecd6d6-2746-86af-d2e8-9776c008cdae-c008cd01"
          )}
          tag="div"
        >
          <_Builtin.Block className={_utils.cx(_styles, "button")} tag="div">
            <_Builtin.Link
              className={_utils.cx(_styles, "button_link-block")}
              button={false}
              block="inline"
            ...
            >
              <_Builtin.Block className={_utils.cx(_styles, "tag")} tag="div">
                ...
                />
                <_Builtin.Block
                  className={_utils.cx(_styles, "button_label", "is-icon")}
                  tag="div"
                >
                  {memoriesText}
                </_Builtin.Block>
          ...
          <_Builtin.Block
            ...
            id={_utils.cx(
              _styles,
              "w-node-_072c5ad0-617a-b53b-de8b-8f4f03b136c7-c008cd01"
            )}
            tag="div"
          >
            <_Builtin.Link
