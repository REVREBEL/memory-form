...
export function ComponentSizeVariant({
  ...
  return (
    ...
    >
      <Block
        className={`component_card-size ${_activeStyleVariant}`}
        tag={"div"}
      >
        <Block
        ...
        <Block
          className={`memory-wall_top-content ${_activeStyleVariant}`}
          tag={"div"}
        >
          <Block
          ...
          >
            ...
            <Block
              className={`location-wrapper ${_activeStyleVariant}`}
              tag={"div"}
            >
              <Block
                className={`location-item ${_activeStyleVariant}`}
                tag={"div"}
              >
                {metaLocationMetaLocationIconVisibility ? (
                  <HtmlEmbed
                    className={`icon location-icon is-white is-relative ${_activeStyleVariant}`}
                    content={""}
                    value={
            ...
            <Block
              className={`shared-by_wrapper ${_activeStyleVariant}`}
              tag={"div"}
            >
              <Block
        ...
        >
          {bottomCardBottomCardSlot ?? (
            <>
              ...
              <Block
                className={`memory-wall_meta-wrapper ${_activeStyleVariant}`}
                tag={"div"}
              >
                <Block
                  className={`memory-wall_summary-card-date ${_activeStyleVariant}`}
