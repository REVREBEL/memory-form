...
import _styles from "./FirstNameField.module.css";

export function FirstNameField({
  as: _Component = _Builtin.Block,
  firstNameFormFieldFormInputVisibility = true,
  firstNameFormFieldFormInputId,
  firstNameFormFieldFormInputSlot,
  firstNameFormFieldFormInputRuntimeProps = {},
  firstNameFormFieldFormInputLabel = "FIrst Name",
}) {
  return firstNameFormFieldFormInputVisibility ? (
    <_Component
      className={_utils.cx(_styles, "form_field-wrapper")}
      tag="div"
      id={firstNameFormFieldFormInputId}
      {...firstNameFormFieldFormInputRuntimeProps}
    >
      {firstNameFormFieldFormInputSlot ?? (
        <>
          ...
          >
            <_Builtin.HtmlEmbed
              className={_utils.cx(_styles, "form-field_icon", "icon-person")}
