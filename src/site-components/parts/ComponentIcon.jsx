...
export function ComponentIcon({ iconVariant = "Flower" }) {
  ...
  return (
    ...
    >
      <Block tag={"div"}>
        ...
        />
        <HtmlEmbed
          className={`button_icon icon-heart compoent-show-hide ${_activeStyleVariant}`}
          content={""}
          value={
        ...
        />
        <HtmlEmbed
          className={`button_icon icon-orange-half compoent-show-hide ${_activeStyleVariant}`}
          content={""}
          value={
        ...
        />
        <HtmlEmbed
          className={`button_icon icon-person compoent-show-hide ${_activeStyleVariant}`}
          content={""}
          value={
        ...
        />
        <HtmlEmbed
          className={`button_icon icon-location compoent-show-hide ${_activeStyleVariant}`}
          content={""}
          value={
        ...
        />
        <Block
          className={`compoent-show-hide ${_activeStyleVariant}`}
          tag={"div"}
        />
      </Block>
    </div>
