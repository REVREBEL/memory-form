...
import _styles from "./MessageField.module.css";

export function MessageField({
  as: _Component = _Builtin.Block,
  shareAMemoryFormInputVisibility = true,
  shareAMemoryFormInputId,
  shareAMemoryFormInputCharactersSlot,
  shareAMemoryFormInputLabel = "",
  shareAMemoryFormInputRuntimeProps = {},
}) {
  return shareAMemoryFormInputVisibility ? (
    <_Component
      className={_utils.cx(_styles, "form_field-wrapper")}
      tag="div"
      id={shareAMemoryFormInputId}
    >
      <_Builtin.FormBlockLabel
        className={_utils.cx(_styles, "form_label")}
        htmlFor="Phone"
      >
        <_Builtin.Strong className={_utils.cx(_styles, "input_label")}>
          {"Your Message *"}
        </_Builtin.Strong>
      </_Builtin.FormBlockLabel>
      <_Builtin.Block
      ...
      >
        ...
        <_Builtin.FormBlockLabel
          ...
          {...shareAMemoryFormInputRuntimeProps}
        >
          {shareAMemoryFormInputCharactersSlot ?? shareAMemoryFormInputLabel}
        </_Builtin.FormBlockLabel>
      </_Builtin.Block>
    </_Component>
  ) : null;
